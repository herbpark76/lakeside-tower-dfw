...
export const mockRsvps: Rsvp[] = [
  // Wine tasting (evt-wine-tasting)
  { eventId: 'evt-wine-tasting', userId: 'demo-owner-a', displayName: 'Sample Resident A', unit: 'Unit 402', status: 'going', guests: 1, respondedAt: daysFromNowAt(1, 10, 0) },
  { eventId: 'evt-wine-tasting', userId: 'rsvp-2', displayName: 'Fictional Resident B', unit: 'Unit 501', status: 'going', guests: 0, respondedAt: daysFromNowAt(1, 11, 0) },
  { eventId: 'evt-wine-tasting', userId: 'rsvp-3', displayName: 'Fictional Resident C', unit: 'Unit 608', status: 'going', guests: 1, respondedAt: daysFromNowAt(2, 9, 0) },
  { eventId: 'evt-wine-tasting', userId: 'rsvp-4', displayName: 'Fictional Resident D', unit: 'Unit 701', status: 'maybe', guests: 0, respondedAt: daysFromNowAt(2, 14, 0) },
  { eventId: 'evt-wine-tasting', userId: 'rsvp-5', displayName: 'Fictional Resident E', unit: 'Unit 805', status: 'going', guests: 2, respondedAt: daysFromNowAt(3, 8, 0) },
  { eventId: 'evt-wine-tasting', userId: 'rsvp-6', displayName: 'Fictional Resident F', unit: 'Unit 902', status: 'not_going', guests: 0, respondedAt: daysFromNowAt(3, 16, 0) },
  { eventId: 'evt-wine-tasting', userId: 'rsvp-7', displayName: 'Fictional Resident G', unit: 'Unit 1001', status: 'going', guests: 0, respondedAt: daysFromNowAt(4, 10, 0) },

  // Awards watch party (evt-awards-watch) — no RSVP required, but some RSVPs
  { eventId: 'evt-awards-watch', userId: 'rsvp-8', displayName: 'Fictional Resident H', unit: 'Unit 1105', status: 'going', guests: 1, respondedAt: daysFromNowAt(3, 12, 0) },
  { eventId: 'evt-awards-watch', userId: 'rsvp-9', displayName: 'Fictional Resident I', unit: 'Unit 1202', status: 'going', guests: 0, respondedAt: daysFromNowAt(4, 10, 0) },
  { eventId: 'evt-awards-watch', userId: 'rsvp-10', displayName: 'Fictional Resident J', unit: 'Unit 1504', status: 'going', guests: 2, respondedAt: daysFromNowAt(5, 9, 0) },
  { eventId: 'evt-awards-watch', userId: 'rsvp-11', displayName: 'Fictional Resident B', unit: 'Unit 501', status: 'maybe', guests: 0, respondedAt: daysFromNowAt(5, 15, 0) },
  ...
  // Off-site dinner (evt-offsite-dinner)
  { eventId: 'evt-offsite-dinner', userId: 'rsvp-16', displayName: 'Fictional Resident D', unit: 'Unit 701', status: 'going', guests: 1, respondedAt: daysFromNowAt(5, 10, 0) },
  { eventId: 'evt-offsite-dinner', userId: 'rsvp-17', displayName: 'Fictional Resident F', unit: 'Unit 902', status: 'going', guests: 0, respondedAt: daysFromNowAt(6, 12, 0) },
  { eventId: 'evt-offsite-dinner', userId: 'rsvp-18', displayName: 'Fictional Resident H', unit: 'Unit 1105', status: 'going', guests: 0, respondedAt: daysFromNowAt(7, 9, 0) },
